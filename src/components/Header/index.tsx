                                                    ...
                                                    showProfileMenu && (
                                                        <>
                                                            <ul className="text-blue-600 absolute top-full right-0 whitespace-nowrap bg-white shadow-md rounded-md overflow-hidden w-64 py-1 z-10" onClick={() => setShowProfileMenu(false)}>
                                                                <li>
                                                                    <Link href={`/p/${user.username}`} className={`text-gray-800 hover:bg-blue-200 flex items-center transition duration-300 px-4 py-2 ${pathname.startsWith(`/p/${user.username}`) ? 'bg-blue-200' : ''}`}>
                                                                ...
                                                                </li>
                                                                {
                                                                    user.roles.isAdmin && (
                                                                        <li>
                                                                            <Link href="/admin" className={`text-gray-800 hover:bg-blue-200 flex items-center transition duration-300 px-4 py-2 ${pathname.startsWith('/admin') ? 'bg-blue-200' : ''}`}>
